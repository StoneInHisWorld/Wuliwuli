...
public class DanmuDaoimpl implements DanmuDao {
    ...
    public boolean InsertDanmu(Danmu danmu) {
        ...
        int result=jdbcTemplate.getJdbcTemplate().update(insert_sql,
                new Object[]{danmu.getVid(),danmu.getContent(),danmu.getDsize(),danmu.getColor(),danmu.getDtime(),danmu.getPosition()});
