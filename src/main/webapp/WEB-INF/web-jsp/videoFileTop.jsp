...
<div>
    ...
    <div>
        ...
        <form id="upload_form">
            ...
            <div>
                <div><label for="image_file" style="color: black;
                                    font-size: 30px">请选择投稿视频文件</label></div>
                <div><input type="file" name="files" id="video" /></div>
            </div>
            <div>
                <div><label for="image_file" style="color: black;
                                    font-size: 30px">请选择投稿封面壁纸</label></div>
                <div><input type="file" name="files" id="img" /></div>
            </div>
            <div>
                <div><label for="image_file" style="color: black;
                                    font-size: 30px">请输入视频标题</label></div>
                <div><input type="text" name="biaoti"  id="biaoti" /></div>
            </div>

            <div>
                <div><label for="image_file"
                            style="color: black; font-size: 30px">请输入视频描述</label></div>
                <div><textarea  rows="10" id="miaoshu" cols="70"></textarea></div>
            </div>

            <div>
                <div><label for="image_file" style="color: black; font-size: 30px">请选择投放区域</label></div>
                <div>
                    <label><input name="Fruit" type="radio" value="1"  checked />动画 </label>
                    <label><input name="Fruit" type="radio" value="2" />游戏</label>
                    <label><input name="Fruit" type="radio" value="3" />科技</label>
                </div>
            </div>
            <div>
