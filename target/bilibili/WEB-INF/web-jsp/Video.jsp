...
<div id="app" data-server-rendered="true">
    ...
    <div class="v-wrap" style="margin-left: 175px;margin-top: 20px;margin-bottom: 20px;margin-right: 177px">
        ...
        <div class="l-con">
            ...
            <div id="playerWrap" class="player-wrap" style="background: white ;width: 100%;height: 700px;background-color:rgba(100,175,255,0)">
                <div id="bofqi"  style="width: 150%;height: 700px;">
                    <div class="player_av" style="width: 50%;">
                        <div id="player1"></div>
                    </div>

                    <div style="height: 500px;width: 1000px">
                        <div style="margin-left: 65%;height: 500px">

                            <%
                                if (request.getSession().getAttribute("userName") == null) {
                            %>
                            <button class="btn btn-primary ladda-button" data-style="expand-left" id="login" style="width: 200px;height: 200px;position: relative;left: 700px;top:-600px;background-color: #00a1d6" >
                            <span class="ladda-label"><a href="login.sf"
                                                         style="font-size: 40px; color: white; text-decoration: none;" >登录</a></span>
                            </button>

                            <button class="btn btn-primary ladda-button" data-style="expand-left" id="zhuce"style="width: 200px;height: 200px;position: relative;left: 700px;top:-450px;background-color: #00a1d6">
                            <span class="ladda-label"><a href="zhuce.sf"
                                                         style="font-size: 40px; color: white; text-decoration: none;" >注册</a></span>
                            </button>
                            <%
                            } else {
                            %>

                            <button class="btn btn-primary ladda-button" data-style="expand-left" id="userxinxi" style="width: 200px;height: 200px;position: relative;left: 700px;top:-600px;background-color: #00a1d6">
                            <span class="ladda-label"><a href="Information.sf" style="font-size: 20px; color: white; text-decoration: none;">
                                    用户: <span style="color: white   "><%=request.getSession().getAttribute("userName")%></span>
                            </a></span>
                            </button>
                    ...
                    <div class="all-comments" style="position: relative" >
                        <div class="all-comments-info">
                            ...
                            <div class="box" style="position:relative;">
                                ...
                                <textarea style="min-height: 80px;width: 500px;top: 50px;position: relative;font-size: 30px" placeholder="请在这输入评论" id="message" required="" name="message" ></textarea>
                                <input style="width: 400px;height: 90px;position:absolute; top: 50px;left: 600px;border-radius: 4px;border: 1px solid #00a1d6;
                                padding: 4px 15px;font-size: 14px;color: #fff;background-color: #00a1d6;" type="button" id="button" value="发表">
                        ...
                        <div align="center" style="margin-top: 30px">
                            ...
                            <button type="button" id="buttonhide2" style="background: #00a1d6 ;width : 20% ;border-radius: 4px;top: -70px;left: 800px;height: 90px;color: white;left: 500px;position:relative;border: 1px solid #00a1d6">评论区</button></div>
                        ...
                        <%--    <p class="tit">
                            ...
                            <div id="messDivId" style="position: relative;top:-10px">
                                <c:forEach items="${messagelist}" var="messagelist">
                                    <div class="story">
                                        <div class="opbtn"></div>
                                        <p class="story_t">用户：${messagelist.messageuserName}<span style="margin-left: 85%;"></p>
        ...
        <div id="slide_ad" class="report-wrap-module report-scroll-module"></div>
	...
	<script>
        ...
        var dp = new DPlayer({
            ...
            video: {
                ...
                url: '/bilibili_war_exploded<%=request.getAttribute("dizhi")%>',
                pic: '',
            ...
            danmaku: {
                ...
                api:"/bilibili_war_exploded/insertdanmu/",

                /* api: 'http://127.0.0.1:8000/get_dm',*/
                addition: ['/bilibili_war_exploded/insertdanmu/']
            }
        });
...
//            parseInt(seconds / 60 / 60),
        ...
        $(document).ready(function(){
            ...
            $.ajax({
                url:"/bilibili_war_exploded/insertdanmu/v3/",
                type:'GET',
